...
if ($w == '') {
    ...
    // 회원 기본 알림 데이터 생성
    $sql_alarm = "INSERT INTO detox_member_alarm(mb_id, days, hours, min, isUse, title, description, isDefault) select '{$mb_id}',days,hours,min,isuse,title,description,'Y' from detox_alarm";
    sql_query($sql_alarm);
