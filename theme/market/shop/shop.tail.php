...
<div id="quick" class="tab_wr">
	...
	<div class="qk_innr" style="top: -23px;">
	    <ul class="qk_btn">
            ...
            <?php if ($member['mb_id']) { ?>
            <li class="tab_check tabsTab">
                <a href="<?php echo G5_SHOP_URL; ?>/calculate_history.php"><i class="fa fa-user" aria-hidden="true"></i><span class="sound_only">정산내역 열기</span></a>
            </li>
            <li class="push_set tabsTab">
                <a href="<?php echo G5_SHOP_URL; ?>/setting_alarm.php"><i class="fa fa-user" aria-hidden="true"></i><span class="sound_only">알림 설정</span></a>
            </li>
            <?php }?>
            <?php if ($is_admin == 'super'){ ?>
            <li class="token_push tabsTab">
                <a href="<?php echo G5_SHOP_URL; ?>/firebase_push.php"><i class="fa fa-bell" aria-hidden="true"></i><span class="sound_only">알림 전송</span></a>
            </li>
            <?php }?>
	    </ul>
    </div>
...
<div id="ft" style="background-color: #f5fff0;">
    <div id="ft_wr">
        <ul class="ft_ul">
        	...
        	<li class="ft_call">고객센터 02-3665-9442</li>
        </ul>
	</div>
