...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="it_cust_price">마케팅비용</label></th>
            <td>
                <?php echo help("입력하지 않으면 상품상세페이지에 출력하지 않습니다."); ?>
                <input type="text" name="it_marketing_expenses" value="<?php echo $it['it_marketing_expenses']; ?>" id="it_marketing_expenses" class="frm_input" size="8"> 원
            </td>
<!--            <td class="td_grpset">-->
<!--                <input type="checkbox" name="chk_ca_it_cust_price" value="1" id="chk_ca_it_cust_price">-->
<!--                <label for="chk_ca_it_cust_price">분류적용</label>-->
